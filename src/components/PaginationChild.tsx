...
import { IMetas } from "@/types/common";

interface PaginationChild {
  href: string;
  metaComment?: IMetas | undefined;
}

const PaginationChild: React.FC<PaginationChild> = ({ href, metaComment }) => {
        ...
        {endPage &&
          Array.from({ length: endPage - startPage + 1 }, (_, index) => (
            <PaginationItem key={index}>
              <Link
                href={`${href}?page=${startPage + index}`}
